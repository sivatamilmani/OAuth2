...
public class OAuth2CodeGrantFacebook: OAuth2CodeGrant {
	...
	the response.
	*/
	override func parseAccessTokenResponse(_ data: Data) throws -> OAuth2JSON {
		guard let str = NSString(data: data, encoding: String.Encoding.utf8.rawValue) as? String else {
